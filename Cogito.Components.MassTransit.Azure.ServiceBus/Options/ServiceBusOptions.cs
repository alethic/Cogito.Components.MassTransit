...
namespace Cogito.MassTransit.Azure.ServiceBus.Options
{
    ...
    /// <summary>
    /// Configuration related to the MassTransit service bus. Make this class available within the container to
    /// provide configuration to the MassTransit Bus implementation.
    /// </summary>
    public class ServiceBusOptions
    {

        /// <summary>
        /// Connection string to the Azure Service bus instance.
        /// </summary>
        ...
        /// </summary>
        public Dictionary<string, ServiceBusReceiveEndpointOptions> Endpoints { get; set; }
        ...
        public void Apply(IServiceBusBusFactoryConfigurator configurator)
        {
            ...
            if (LockRenewDelay != null)
                configurator.MaxAutoRenewDuration = (TimeSpan)LockRenewDelay;
